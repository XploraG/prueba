...
<?php
$db = mysqli_connect("localhost", " ", " ", "s4travian");
...
<?php
$db = mysqli_connect("localhost", " ", " ", "s5travian");
$count_users = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE `id` > 4"));
$count_online = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE " . time() . "-`timestamp` < (60*60) AND tribe!=5 AND tribe!=0"));
...
<?php
$db = mysqli_connect("localhost", " ", " ", "s1travian");
$count_users = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE `id` > 4"));
$count_online = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE " . time() . "-`timestamp` < (60*60) AND tribe!=5 AND tribe!=0"));
$t = strtotime('25.12.2020 14:00:00');
if($t > time()){$count_online = 0;}
$timeserver = round((time() - $t) / 86400);
$da = mysqli_fetch_array($db->query("SELECT * FROM `config` WHERE 1"));
$winn = $da['winmoment'];
...
<?php
$db = mysqli_connect("localhost", " ", " ", "s2travian");
$count_users = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE `id` > 4"));
$count_online = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE " . time() . "-`timestamp` < (60*60) AND tribe!=5 AND tribe!=0"));
...
<?php
$db = mysqli_connect("localhost", " ", " ", "s3travian");
$count_users = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE `id` > 4"));
$count_online = mysqli_num_rows($db->query("SELECT * FROM `users` WHERE " . time() . "-`timestamp` < (60*60) AND tribe!=5 AND tribe!=0"));
$t = strtotime('01.01.2021 18:00:00');
if($t > time()){$count_online = 0;}
$timeserver = round((time() - $t) / 86400);
$da = mysqli_fetch_array($db->query("SELECT * FROM `config` WHERE 1"));
$winn = $da['winmoment'];
